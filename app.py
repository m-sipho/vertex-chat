...
def room():
    ...
    return render_template("room.html", code_badge=room, username=name, messages=rooms[room]["messages"])
...
def handle_typing(data):
    ...
    if room and name:
        socketio.emit("user_typing", {"name": name, "room": room}, skip_sid=request.sid)
...
def handle_stop_typing(data):
    ...
    if room and name:
        socketio.emit("user_stop_typing", {"name": name, "room": room})
